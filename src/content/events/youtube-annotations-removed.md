...
severity: "total"
summary: "YouTube deleted all existing annotations from every video, killing an entire genre of interactive video art — choose-your-own-adventure narratives, in-video games, and clickable overlays all became inert."
links:
  - url: "https://waxy.org/2018/11/a-tribute-to-youtube-annotations/"
    label: "Waxy: A Tribute to YouTube Annotations"
...
fixes:
  - type: workaround
    description: "The 'Annotations Restored' Chrome extension attempts to re-render annotations using archived data, but coverage is incomplete."
  - type: none
    description: "No official replacement preserves the interactive overlay paradigm. YouTube's Cards and End Screens are far more limited."
---
