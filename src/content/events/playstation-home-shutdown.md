...
severity: "total"
summary: "Sony shut down PlayStation Home servers worldwide on March 31, 2015, deleting years of user-created virtual spaces, architecture, and designed environments from the PS3 3D social world with no ceremony and no archive."
links:
  - url: "https://en.wikipedia.org/wiki/PlayStation_Home"
    label: "Wikipedia: PlayStation Home"
fixes:
  - type: emulation
    description: "Fan reverse-engineering projects have reconstructed some spaces (Hub, Bowling Alley, Playground) running on modified PS3 hardware."
  - type: none
    description: "The vast majority of user-created and commercially produced virtual spaces are permanently lost."
---
