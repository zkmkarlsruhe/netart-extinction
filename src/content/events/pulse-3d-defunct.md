...
severity: "total"
summary: "Pulse Entertainment abandoned its 3D web browser plugin around 2001 when the company pivoted to mobile. The plugin streamed interactive 3D animations at ~330KB — content from Warner Bros, Jim Henson, and others is now unviewable."
links:
  - url: "https://lostmediawiki.com/Pulse_3D_(partially_found_3D_web_plugin_content;_1999-2001)"
    label: "Lost Media Wiki: Pulse 3D"
  - url: "https://archive.org/details/Pulse3DWebPlugin"
    label: "Internet Archive: Pulse 3D Web Plugin"
  - url: "https://archive.org/details/Pulse3DPWSPWCPW3Files"
    label: "Internet Archive: Pulse 3D content files"
fixes:
  - type: archive
    description: "The plugin installer and some PWS/PWC content files survive on the Internet Archive, but no modern browser can run them."
  - type: none
    description: "No emulator exists for the Pulse 3D format. The proprietary file formats (PWS, PWC, PW3) have no open-source viewer."
---
