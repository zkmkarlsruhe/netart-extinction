...
severity: "total"
summary: "Mac OS X 10.5 Leopard removed the Classic environment, the compatibility layer that ran Mac OS 9 applications within OS X. HyperCard stacks, early interactive art, and CD-ROM art built for Mac OS 9 and earlier became unrunnable on current Macs."
links:
  - url: "https://en.wikipedia.org/wiki/Classic_(Mac_OS_X)"
    label: "Wikipedia: Classic (Mac OS X)"
fixes:
  - type: emulation
    description: "Mac OS 9 can be run in emulators like SheepShaver or QEMU. The Internet Archive's HyperCard project uses in-browser emulation."
  - type: none
    description: "No path exists to run Classic Mac applications natively on any current Apple hardware or operating system."
---
