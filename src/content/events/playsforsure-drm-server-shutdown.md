...
severity: "total"
summary: "In April 2008, Microsoft announced it would shut down MSN Music's PlaysForSure DRM license servers by August 31, stranding customers' legally purchased music on their currently authorized machines. After public outcry, the deadline was extended to 2011 — but the music was still ultimately lost to anyone who changed computers or reinstalled Windows."
links:
  - url: "https://en.wikipedia.org/wiki/Microsoft_PlaysForSure"
    label: "Wikipedia: Microsoft PlaysForSure"
  - url: "https://en.wikipedia.org/wiki/MSN_Music"
    label: "Wikipedia: MSN Music"
  - url: "https://www.audioholics.com/news/drm-plays-for-sure"
    label: "Audioholics: DRM Strikes Again — Plays for Sure to Play no More"
  - url: "https://boingboing.net/2008/04/22/msn-music-customers.html"
    label: "Boing Boing: MSN Music customers lose all their music"
  - url: "https://opensource.com/life/11/11/drm-graveyard-brief-history-digital-rights-management-music"
    label: "The DRM graveyard: A brief history of DRM in music"
fixes:
  - type: none
    description: "Once the license servers were decommissioned, there was no way to authorize new devices. Music files still exist as .wma files but cannot be decrypted without valid license keys, making them permanently unplayable through legitimate means."
---
