...
severity: "total"
summary: "Adobe ceased Authorware development in September 2007 after acquiring Macromedia. The Authorware Web Player, required to run .aam packaged content in browsers, was never updated for modern browsers or 64-bit systems, making the format completely inaccessible — with no emulator, converter, or open-source reader ever developed."
links:
  - url: "https://en.wikipedia.org/wiki/Authorware"
    label: "Wikipedia: Macromedia Authorware"
  - url: "https://helpx.adobe.com/authorware/kb/authorware-702-end-sale-dates.html"
    label: "Adobe: Authorware end of sale dates"
fixes:
  - type: emulation
    description: "Run in a Windows XP/7 virtual machine with Internet Explorer 6–8 and the Authorware Web Player installed. 32-bit systems only."
  - type: none
    description: "No converter, decompiler, or open-source player for Authorware content has ever been created. The proprietary flowchart-based format has no modern equivalent."
---
