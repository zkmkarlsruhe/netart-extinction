...
affected_artworks:
  ...
  - artwork: "carnivore"
    severity: total
    status: dead
  - artwork: "conversations-with-fransesca"
    severity: total
    status: dead
  ...
  - artwork: "telematic-surveillance"
    severity: total
    status: dead
  - artwork: "the-central-city-net-art-edition"
    severity: total
    status: dead
  ...
  - artwork: "the-jetty"
    severity: total
    status: dead
  - artwork: "the-lair-of-the-marrow-monkey"
    severity: total
    status: dead
  ...
  - artwork: "the-well"
    severity: total
    status: dead
  - artwork: "thebot-one-infesting-the-horse"
    severity: total
    status: dead
  - artwork: "trapped"
    severity: total
