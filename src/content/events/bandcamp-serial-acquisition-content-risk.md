...
event_type: "corporate-acquisition"
severity: "major"
summary: "Bandcamp — the largest independent music platform with millions of albums — was sold from Epic Games to music licensing company Songtradr in September 2023, resulting in the layoff of half its staff and raising serious concerns about the long-term survival of its catalog as a music archive."
links:
  - url: "https://blog.bandcamp.com/2023/11/22/songtradr-acquires-bandcamp/"
    label: "Bandcamp blog: Songtradr Acquires Bandcamp"
  - url: "https://mixmag.net/read/bandcamp-layoffs-songtradr-acquisition-union-epic-games-news"
    label: "Mixmag: Half of Bandcamp's staff let go following Songtradr acquisition"
  - url: "https://www.musicbusinessworldwide.com/5-observations-on-epic-games-sale-of-bandcamp-to-songtradr/"
    label: "Music Business Worldwide: 5 observations on Epic's sale of Bandcamp to Songtradr"
fixes:
  - type: workaround
    description: "Artists can download their own uploaded source files and re-host them. Buyers can re-download purchased music from their Bandcamp collections — for now."
  - type: none
    description: "No guarantee exists that Bandcamp's catalog, streaming links, or artist pages will remain accessible long-term under new ownership."
---
