...
severity: "total"
summary: "Twitter shut down the Vine app on January 17, 2017, ending the 6-second looping video platform. A read-only archive was launched but then quietly deleted in April 2019, compounding the loss of a distinct micro-video art form."
links:
  - url: "https://en.wikipedia.org/wiki/Vine_(service)"
    label: "Wikipedia: Vine (service)"
  - url: "https://www.engadget.com/2017/01/20/vine-archive/"
    label: "Engadget: Vine creates searchable video archive"
fixes:
  - type: archive
    description: "Some Vines survive in YouTube compilations, personal saves, and partial Internet Archive captures, but no comprehensive archive exists."
  - type: none
    description: "The 6-second constrained loop format has no direct successor platform."
---
