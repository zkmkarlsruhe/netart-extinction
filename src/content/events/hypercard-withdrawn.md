...
severity: "total"
summary: "Apple withdrew HyperCard from sale in March 2004, killing the pioneering hypermedia authoring system that had been a precursor to the web itself. HyperCard was never ported to Mac OS X — it only ran in the Classic environment, which was removed in Leopard (2007)."
links:
  - url: "https://en.wikipedia.org/wiki/HyperCard"
    label: "Wikipedia: HyperCard"
  - url: "https://blog.archive.org/2017/08/11/hypercard-on-the-archive-celebrating-30-years-of-hypercard/"
    label: "Internet Archive: HyperCard on the Archive"
  - url: "https://www.loc.gov/preservation/digital/formats/fdd/fdd000537.shtml"
    label: "Library of Congress: HyperCard Stack format"
fixes:
  - type: emulation
    description: "The Internet Archive established a HyperCard emulation project in 2017, allowing stacks to run in-browser via Mac OS emulation."
  - type: none
    description: "HyperCard's card-based authoring paradigm has no direct modern equivalent. Stacks cannot be edited without running a Classic Mac OS environment."
---
