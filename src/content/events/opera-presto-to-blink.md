...
severity: "minor"
summary: "Opera 15 abandoned the Presto rendering engine for Chromium/Blink, eliminating one of four independent browser engines and advancing the monoculture that reduces the diversity of how web art can be rendered and experienced."
links:
  - url: "https://en.wikipedia.org/wiki/Presto_(browser_engine)"
    label: "Wikipedia: Presto (browser engine)"
fixes:
  - type: none
    description: "Presto is gone. The unique rendering behaviors it produced cannot be experienced in any current browser."
---
