...
severity: "major"
summary: "Between 2008 and 2014, major international broadcasters including the BBC World Service and Radio Netherlands Worldwide eliminated most shortwave transmissions, dismantling the physical infrastructure that transmission artists and radio art practitioners had used as both medium and material since the 1980s."
links:
  - url: "https://www.radioworld.com/global/debating-the-impact-of-bbc-world-service-cuts"
    label: "Radio World: Debating the Impact of BBC World Service Cuts"
  - url: "https://en.wikipedia.org/wiki/Radio_Netherlands_Worldwide"
    label: "Wikipedia: Radio Netherlands Worldwide"
  - url: "https://monoskop.org/Radio_art"
    label: "Monoskop: Radio art"
  - url: "https://www.radiosurvivor.com/2018/10/ubuwebs-treasure-trove-of-avant-garde-radio-and-sound/"
    label: "Radio Survivor: UbuWeb's Treasure Trove of Avant-Garde Radio and Sound"
  - url: "https://www.earlid.org/posts/radios-art/"
    label: "Earlid: Radio's Art"
fixes:
  - type: archive
    description: "Some radio art works survive as recordings on UbuWeb and institutional archives, but these capture only the audio content, not the transmission experience — the atmospheric noise, fading, interference, and spatial qualities that were integral to the art form."
  - type: none
    description: "The shortwave transmission infrastructure itself — high-power transmitters, antenna arrays, relay stations — has been physically dismantled in many cases. The medium no longer exists at the scale required for the art form to function."
---
